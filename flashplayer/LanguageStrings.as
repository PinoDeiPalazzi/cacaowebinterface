package {
	...
	public class LanguageStrings {
		...
		public function LanguageStrings() {
			...
			languagestrings['en']['pleaselogin'] = "Please log in or register to continue";
			...
			languagestrings['en']['links'] = "links";
			languagestrings['en']['downloadlink'] = "download link:";
			languagestrings['en']['embedcode'] = "embed code:";
			languagestrings['en']['limitreached'] = "TIME LIMIT REACHED!<br><br><a href=\"http://cacaoweb.org/buypremium.html\" target=\"_blank\"><u>click to log in or become premium to watch without limit</u></a>";
			languagestrings['en']['waitlimit'] = "or wait {0} min";
			...
			languagestrings['es']['links'] = "links";
			languagestrings['es']['downloadlink'] = "download link:";
			languagestrings['es']['embedcode'] = "embed code:";
			languagestrings['es']['limitreached'] = "TIME LIMIT REACHED!<br><br><a href=\"http://cacaoweb.org/buypremium.html\" target=\"_blank\"><u>click to log in or become premium to watch without limit</u></a>";
			languagestrings['es']['waitlimit'] = "or wait {0} min";
			...
			languagestrings['fr']['links'] = "liens";
			languagestrings['fr']['downloadlink'] = "lien de téléchargement:";
			languagestrings['fr']['embedcode'] = "code html intégré:";
			languagestrings['fr']['limitreached'] = "LIMITE DE TEMPS ATTEINTE!<br><br><a href=\"http://cacaoweb.org/buypremium.html\" target=\"_blank\"><u>cliquez pour vous logger ou devenir premium pour regarder sans limite</u></a>";
			languagestrings['fr']['waitlimit'] = "ou attendez {0} min";
			...
			languagestrings['it']['cacaowebdownload'] = "Download";
			...
			languagestrings['it']['links'] = "links";
			languagestrings['it']['downloadlink'] = "download link:";
			languagestrings['it']['embedcode'] = "embed code:";
			languagestrings['it']['limitreached'] = "RAGGIUNTO IL LIMITE DI TEMPO!<br><br><a href=\"http://cacaoweb.org/buypremium.html\" target=\"_blank\"><u>clicca qui per accedere o diventare premium a guardare senza limite</u></a>";
			languagestrings['it']['waitlimit'] = "o attendere {0} min";
			...
			languagestrings['pl']['links'] = "links";
			languagestrings['pl']['downloadlink'] = "download link:";
			languagestrings['pl']['embedcode'] = "embed code:";
			languagestrings['pl']['limitreached'] = "TIME LIMIT REACHED!<br><br><a href=\"http://cacaoweb.org/buypremium.html\" target=\"_blank\"><u>click to log in or become premium to watch without limit</u></a>";
			languagestrings['pl']['waitlimit'] = "or wait {0} min";
